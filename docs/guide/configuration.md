...
For normal use, open `OpenWarp.app` and choose **Settings → Agent Engine**. The local web endpoint exists behind that page, but users usually do not need to visit it directly.
